function GridElement() {
  ...
  this.hVal; // heuristic (distance from tile to dest)
  this.fCost;
  ...
  this.reset = function() {
    ...
    this.fCost = INFINITY_START_DISTANCE;
    this.cameFrom = null;
  }
  ...
  this.calculateHVal = function(endC, endR) {
    deltaX = endC - this.tilC;
    deltaY = endR - this.tilR;
